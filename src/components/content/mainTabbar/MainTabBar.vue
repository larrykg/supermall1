<template>
  <tab-bar>
    <tab-bar-item path="/home" activeColor="#e4393c">
      <img src="~assets/img/tabbar/home.svg" alt="" slot="item-icon">
      <img src="~assets/img/tabbar/home_active.svg" alt="" slot="item-icon-active">
      <div slot="item-text">首页</div>
    </tab-bar-item>
    <tab-bar-item path="/category" activeColor="#e4393c">
    ...
    <tab-bar-item path="/cart" activeColor="#e4393c">
    ...
    <tab-bar-item path="/profile" activeColor="#e4393c">
